<template>
  <div class="container">
      <h1>INMUEBLES DEL CONTRIBUYENTE NATURAL</h1>
      ...
      <div class="modal-body">
        ...
        <div class='row'>
            <div class="col-md-2">
                ...
                <input type="text" class="form-control" id="distrito" required v-model="dato.distrito" value='' maxlength="4">
            </div>
            <div class="col-md-2">
                <label for="manzano" class="form-label">manzano</label>
                <input type="text" class="form-control" id="manzano"  v-model="dato.manzano" value='' maxlength="4">
            </div>
            <div class="col-md-2">
                <label for="lote" class="form-label">lote</label>
                <input type="text" class="form-control" id="lote"  v-model="dato.lote" value='' maxlength="4">
            </div>
            <div class="col-md-2">
                <label for="sublote" class="form-label">sublote</label>
                <input type="text" class="form-control" id="sublote"  v-model="dato.sublote" value='' maxlength="4">
            </div>
            <div class="col-md-4">
            ...
            <div class="modal-body">
                ...
                <div class='row'>
                    <div class="col-md-2">
                        ...
                        <input type="text" class="form-control" id="moddistrito" required v-model="modif.distrito" value='' style="text-transform:uppercase;" maxlength="4">
                    </div>
                    <div class="col-md-2">
                        <label for="modmanzano" class="form-label">manzano</label>
                        <input type="text" class="form-control" id="modmanzano"  v-model="modif.manzano" value='' maxlength="4">
                    </div>
                    <div class="col-md-2">
                        <label for="modlote" class="form-label">lote</label>
                        <input type="text" class="form-control" id="modlote"  v-model="modif.lote" value='' maxlength="4">
                    </div>
                    <div class="col-md-2">
                        <label for="modsublote" class="form-label">sublote</label>
                        <input type="text" class="form-control" id="modsublote"  v-model="modif.sublote" value='' maxlength="4">
                    </div>
                    <div class="col-md-4">
