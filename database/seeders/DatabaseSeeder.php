...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert(['name'=>'Dolores Franco','username'=>'DOFRANCO','password'=>Hash::make('JU123456')]);
        DB::table('users')->insert(['name'=>'Juan Paco','username'=>'JUPACO','password'=>Hash::make('JO123456')]);
        DB::table('users')->insert(['name'=>'Jorge Cox','username'=>'JOCOX','password'=>Hash::make('AM123456')]);
